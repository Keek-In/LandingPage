const Pricing = () => {
    return (
      <div className="w-[1440px] h-[900px] bg-[#0D121F] pt-[26px] px-[111px] pb-[123px]">
        <p className="text-[#1A71F6] font-semibold text-[18px] leading-[28px] font-['Inter'] mt-[26px]">
          Pricing & Plan for{" "}
          ...
          <div className="w-[390px] h-[497px] bg-[#1A202C] rounded-[8px] px-[35px]">
            ...
            <div className="flex items-center justify-left gap-[10px] mt-[28.86px]">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
                <path d="M4.1665 11.446L7.49984 14.7794L15.8332 6.44604" stroke="#1A71F6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
              <span className="text-[#FFF] text-[16px] font-['Inter'] ml-[9px]">Complete Documentation</span>
            </div>
            <div className="flex items-center justify-left gap-[10px] mt-[12px]">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
                <path d="M4.1665 11.446L7.49984 14.7794L15.8332 6.44604" stroke="#1A71F6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
              <span className="text-[#FFF] text-[16px] font-['Inter'] ml-[9px]">Working Materials in Figma</span>
            </div>
            <div className="flex items-center justify-left gap-[10px] mt-[12px]">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
                <path d="M4.1665 11.446L7.49984 14.7794L15.8332 6.44604" stroke="#1A71F6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
              <span className="text-[#FFF] text-[16px] font-['Inter'] ml-[9px]">100GB Cloud Storage</span>
            </div>
            <div className="flex items-center justify-left gap-[10px] mt-[12px]">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
                <path d="M4.1665 11.446L7.49984 14.7794L15.8332 6.44604" stroke="#B2B2B2" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
              <span className="text-[#B2B2B2] text-[16px] font-['Inter'] ml-[9px]">Email Automation</span>
            </div>
            <div className="flex items-center justify-left gap-[10px] mt-[12px]">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
                <path d="M4.1665 11.446L7.49984 14.7794L15.8332 6.44604" stroke="#B2B2B2" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
              <span className="text-[#B2B2B2] text-[16px] font-['Inter'] ml-[9px]">Premium Support</span>
            </div>
          </div>

...
const Testimonials = () => {
  return (
    <div className="w-[1440px] h-[967px] bg-[#FFFFFF] p-[120px]">
      ...
      <p className="testimonials-subtext">
        We love and value our vibrant community who've experienced the power of Keek firsthand.
      </p>
      ...
      <div className="flex justify-center gap-[24px] mt-[64px]">
        ...
        <button className="flex items-center justify-center w-[48px] h-[50px] bg-[#F3F5F7] rounded-full p-[16px] gap-[8px] hover:bg-[#1A71F6] transition-all">
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
           <path d="M10.8225 4.44727L15.375 8.99977L10.8225 13.5523" stroke="#C3D4E9" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
           <path d="M15.3749 9H2.75244" stroke="#C3D4E9" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
        </button>
      </div>
